...
fetchLibrustyV8SrcBinding {
  ...
  shas = {
    ...
    x86_64-darwin = "$(nix-prefetch-url --type sha256 https://github.com/denoland/rusty_v8/releases/download/v"$NEW_VERSION"/src_binding_release_x86_64-apple-darwin.rs)";
  };
}
EOF
